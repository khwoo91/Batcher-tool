...
export class AlertModal extends LitElement {
  ...
  protected override render() {
    ...
    return html`
      ...
      >
        <div
          class="bg-slate-900 border border-slate-800 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-150"
        >
          <div class="p-6">
            <div class="flex items-center gap-4 mb-4">
              <div
                class="p-3 rounded-xl shrink-0 ${this.type === "success"
            ...
            <div
              class="text-sm text-slate-300 whitespace-pre-wrap leading-relaxed font-sans"
            >
              ${this.message}
            </div>
          </div>
