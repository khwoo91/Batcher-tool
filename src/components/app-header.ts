    ...
    return html`
      ...
      >
        <div class="flex items-center gap-4">
          <div
            class="bg-indigo-600 text-white p-3 rounded-2xl shadow-lg shadow-indigo-500/20"
          >
            <svg
              class="w-8 h-8"
              fill="none"
          ...
          ${this.hasFiles
            ? html`
                <button
                  ...
                  class="px-4 py-2 border border-slate-800 hover:border-slate-700 bg-slate-900 text-slate-300 rounded-xl text-sm transition-all flex items-center gap-2 font-sans"
                >
